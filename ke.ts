...
function calculateSinglePhase(units: number, noOfTV: number) {
...
function calculateThreePhase(units: number, noOfTV: number) {
...
function displayTable(phase: string, units: number, noOfTV: number, charges: any) {
    let table = new Table({
    ...
    table.push(
        ...
        ['Units Billed', units],
        ['No. of TV', noOfTV],
        ['Variable Charges', charges.variableCharges],
        ['Minimum Charges', charges.minimumCharges],
        ['PHL Surcharge', charges.phlSurcharge],
        ['Excise Duty', charges.exciseDuty],
        ['TV License', charges.tvLicense],
        ['Sales Tax', charges.salesTax],
        ['Taxable Amount', charges.taxableAmount],
        ['Income Tax', charges.incomeTax],
        ['Net Amount of Current Bill', charges.netAmount]
    );
